...
def send_feedback_email(user_email, name, subject):
    ...
    try:
     ...
     <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; position: relative; overflow: hidden; background-color: #000;">
            ...
            <!-- GIF as an absolute-positioned image to simulate background -->
            <img src="https://ik.imagekit.io/nzsjpnm8w/loop.gif?updatedAt=1743683898622" 
                 alt="Animated Infinity Loop" 
                 style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 100%; height: 100%; object-fit: cover; opacity: 0.85; z-index: 0;">

            <!-- Content -->
            <div style="background-color: rgba(0, 0, 0, 0.8); padding: 20px; text-align: center; position: relative; z-index: 1;">
                <h1 style="color: #00c3ff; margin: 0; text-shadow: 0 0 10px rgba(0, 195, 255, 0.5);">Thank You!</h1>
            </div>
            ...
            <div style="padding: 20px; background-color: rgba(0, 0, 0, 0.7); position: relative; z-index: 1; border-radius: 10px;">
                ...
                <p style="color: #fff;">If you have any urgent queries or need further assistance, feel free to contact us at 
                   <span style="color: #00c3ff;">support@luphonix.com</span>.
                </p>

                <p style="color: #fff;">We look forward to assisting you and hope to make a positive impact together!</p>

                <!-- Team signature with logo using table -->
                <table style="width: 100%; color: #fff; margin-top: 20px;">
                    <tr>
                        <td style="text-align: left; vertical-align: middle;">
                            <p style="margin: 0;">Warm regards,<br>The Luphonix Team</p>
                        </td>
                        <td style="text-align: right; vertical-align: middle; width: 70px;">
                            <img src="https://ik.imagekit.io/nzsjpnm8w/blue_phoenix_logo.jpg?updatedAt=1743683879054" 
                                 alt="Luphonix Logo" style="width: 70px;">
                        </td>
                    </tr>
                </table>
            </div>
